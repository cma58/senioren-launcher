...
data class AppSettings(
    ...
    val visibleApps: Set<String> = setOf("phone", "sms", "camera", "photos", "radio", "meds", "emergency", "sos", "remote_support", "wifi", "bluetooth", "settings"),
...
val ALL_APPS = listOf(
    ...
    AppInfo("bluetooth", "Bluetooth", "📶", "📶", 0xFF4A5568),
